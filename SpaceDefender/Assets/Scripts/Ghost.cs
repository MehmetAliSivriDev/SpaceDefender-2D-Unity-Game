...
public class Ghost : MonoBehaviour
{
    ...
    private bool isDying = false; // Ölme durumu kontrolü

    //Ses
    [SerializeField] private AudioSource audioSource; // Ghost için ses kaynaðý
    [SerializeField] private AudioClip spawnSound; // Doðma sesi klibi
    void Start()
    {
